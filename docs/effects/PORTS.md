...
| cycles/sample | LINE (JUNO/DIM/FLNG) 401, PHSR 476, COMB 314 (306 + the trim; ENS was 440) |
...
| heard | 16 Sep 2026 on the emulator: JUNO/DIM/PHSR good, FLNG good at RATE 8, COMB kept, ENS dropped; per-mode output trims DIM −8 / FLNG −7 / PHSR −2 / COMB −12 dB (`modules/modulation/README.md`); unheard on the unit |
