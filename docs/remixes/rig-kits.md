...
- **SCENES KITS** (octabam) — the bridge that lets CC PAGE 2 and Octakit share the MIDI CC dispatch entry: CCs 62–67 CC PAGE 2's, then Octakit's, then stock's. Nothing of its own to use.
