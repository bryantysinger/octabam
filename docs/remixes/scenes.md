...
MIDI SCENES + the LO-FI AMF fix + CC MAP. Every stock effect stays.
...
Boots under the ColdFire port. Not flashed; MIDI SCENES has run on hardware in `ok-ms`, CC MAP in the rig.
