...
Three ColdFire caves and the stock effects. For anyone whose recorder loops click at the seam.
...
The three caves plus the bus were measured on hardware as OCTABAM83 (12 Sep 2026): zero of 46 bars above 1.25× where the previous image had 16; 128 BPM reads identical to the stock golden capture. This remix without the bus is port-gated only. Whether RECORDER SPACING alone suffices is untested. `docs/firmware/RECORDER_CLICK.md` has the reproduction.
