...
- **Character** (FX1, on LO-FI's id) — crush, fold/ring, saturation, compressor, width; the bus return (RET) on track 8, default 127, named `---` with no value on tracks 1-7. Knobs DRV FOLD TXTR COMP RET MIX / SAT TONE WDTH (16 Sep 2026: MIX bottom right on page 1; SAT top left on page 2, where every effect's MODE sits).
