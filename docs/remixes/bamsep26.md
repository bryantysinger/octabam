...
- Image 51 moved Character's WDTH to page-1 slot 2 (TXTR's) and emptied page-2 slot 7: stamp, or re-select Character on each track. BusDelay works on T1 only and BusVerb on T5 only; the stamp warns about either anywhere else.
