...
module whose proc ends inside it tears its block; BusDelay computes
from a `frameend` detour after the last copy instead (build_bus
FRAMEEND); after each FX2 call (`P:0x50d`)
